...
class IndiceFinanceiro(models.Model):
    ...
    def __unicode__(self):
        ...
        return "{} >> Prazo: {} dias, Taxa: {:6.2f}%".format(
                self.__class__._meta.verbose_name, self.maturity, self.rate
            )

class IndiceSELIC(IndiceFinanceiro):
...
class IndiceIGPM(IndiceFinanceiro):
...
class IndiceIPCA(IndiceFinanceiro):
