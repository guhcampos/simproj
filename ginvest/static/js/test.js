...
function test_simulation() {
  ...
  mdata[1] = ['Q','2014-06-26','18997.00'];
  mdata[2] = ['R','2014-06-27',"2438.00"];
  mdata[3] = ['S','2014-06-28','-633.17'];
  mdata[4] = ['T','2014-06-29','-20.00'];
  mdata[5] = ['U','2014-06-30','-45.00'];
  mdata[6] = ['V','2014-07-01','200.00'];
  mdata[7] = ['W','2014-07-02','999.00'];
  mdata[8] = ['X','2014-07-03','666.00'];
  mdata[9] = ['Y','2014-07-04','-666.00'];
  mdata[10] = ['Z','2014-07-05','317.00'];
